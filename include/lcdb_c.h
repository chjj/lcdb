...
#define leveldb_open ldb__leveldb_open
#define leveldb_close ldb__leveldb_close
#define leveldb_put ldb__leveldb_put
#define leveldb_delete ldb__leveldb_delete
#define leveldb_write ldb__leveldb_write
#define leveldb_get ldb__leveldb_get
#define leveldb_create_iterator ldb__leveldb_create_iterator
#define leveldb_create_snapshot ldb__leveldb_create_snapshot
#define leveldb_release_snapshot ldb__leveldb_release_snapshot
#define leveldb_property_value ldb__leveldb_property_value
#define leveldb_approximate_sizes ldb__leveldb_approximate_sizes
#define leveldb_compact_range ldb__leveldb_compact_range
#define leveldb_destroy_db ldb__leveldb_destroy_db
#define leveldb_repair_db ldb__leveldb_repair_db
#define leveldb_iter_destroy ldb__leveldb_iter_destroy
#define leveldb_iter_valid ldb__leveldb_iter_valid
#define leveldb_iter_seek_to_first ldb__leveldb_iter_seek_to_first
#define leveldb_iter_seek_to_last ldb__leveldb_iter_seek_to_last
#define leveldb_iter_seek ldb__leveldb_iter_seek
#define leveldb_iter_next ldb__leveldb_iter_next
#define leveldb_iter_prev ldb__leveldb_iter_prev
#define leveldb_iter_key ldb__leveldb_iter_key
#define leveldb_iter_value ldb__leveldb_iter_value
#define leveldb_iter_get_error ldb__leveldb_iter_get_error
#define leveldb_writebatch_create ldb__leveldb_writebatch_create
#define leveldb_writebatch_destroy ldb__leveldb_writebatch_destroy
#define leveldb_writebatch_clear ldb__leveldb_writebatch_clear
#define leveldb_writebatch_put ldb__leveldb_writebatch_put
#define leveldb_writebatch_delete ldb__leveldb_writebatch_delete
#define leveldb_writebatch_iterate ldb__leveldb_writebatch_iterate
#define leveldb_writebatch_append ldb__leveldb_writebatch_append
#define leveldb_options_create ldb__leveldb_options_create
#define leveldb_options_destroy ldb__leveldb_options_destroy
#define leveldb_options_set_comparator ldb__leveldb_options_set_comparator
#define leveldb_options_set_filter_policy ldb__leveldb_options_set_filter_policy
#define leveldb_options_set_create_if_missing ldb__leveldb_options_set_create_if_missing
#define leveldb_options_set_error_if_exists ldb__leveldb_options_set_error_if_exists
#define leveldb_options_set_paranoid_checks ldb__leveldb_options_set_paranoid_checks
#define leveldb_options_set_env ldb__leveldb_options_set_env
#define leveldb_options_set_info_log ldb__leveldb_options_set_info_log
#define leveldb_options_set_write_buffer_size ldb__leveldb_options_set_write_buffer_size
#define leveldb_options_set_max_open_files ldb__leveldb_options_set_max_open_files
#define leveldb_options_set_cache ldb__leveldb_options_set_cache
#define leveldb_options_set_block_size ldb__leveldb_options_set_block_size
#define leveldb_options_set_block_restart_interval ldb__leveldb_options_set_block_restart_interval
#define leveldb_options_set_max_file_size ldb__leveldb_options_set_max_file_size
#define leveldb_options_set_compression ldb__leveldb_options_set_compression
#define leveldb_comparator_create ldb__leveldb_comparator_create
#define leveldb_comparator_destroy ldb__leveldb_comparator_destroy
#define leveldb_filterpolicy_create ldb__leveldb_filterpolicy_create
#define leveldb_filterpolicy_destroy ldb__leveldb_filterpolicy_destroy
#define leveldb_filterpolicy_create_bloom ldb__leveldb_filterpolicy_create_bloom
#define leveldb_readoptions_create ldb__leveldb_readoptions_create
#define leveldb_readoptions_destroy ldb__leveldb_readoptions_destroy
#define leveldb_readoptions_set_verify_checksums ldb__leveldb_readoptions_set_verify_checksums
#define leveldb_readoptions_set_fill_cache ldb__leveldb_readoptions_set_fill_cache
#define leveldb_readoptions_set_snapshot ldb__leveldb_readoptions_set_snapshot
#define leveldb_writeoptions_create ldb__leveldb_writeoptions_create
#define leveldb_writeoptions_destroy ldb__leveldb_writeoptions_destroy
#define leveldb_writeoptions_set_sync ldb__leveldb_writeoptions_set_sync
#define leveldb_cache_create_lru ldb__leveldb_cache_create_lru
#define leveldb_cache_destroy ldb__leveldb_cache_destroy
#define leveldb_create_default_env ldb__leveldb_create_default_env
#define leveldb_env_destroy ldb__leveldb_env_destroy
#define leveldb_env_get_test_directory ldb__leveldb_env_get_test_directory
#define leveldb_free ldb__leveldb_free
#define leveldb_major_version ldb__leveldb_major_version
#define leveldb_minor_version ldb__leveldb_minor_version
